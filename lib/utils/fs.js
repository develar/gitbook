...
function ensureFile(filename) {
    return fsExtra.ensureDir(path.dirname(filename));
}

// Remove a folder
function rmDir(base) {
    return fsExtra.remove(base)
}
...
function ensureFolder(rootFolder) {
    return fsExtra.emptyDir(rootFolder)
}

module.exports = {
    exists: fileExists,
    existsSync: fs.existsSync,
    mkdirp: fsExtra.ensureDir,
